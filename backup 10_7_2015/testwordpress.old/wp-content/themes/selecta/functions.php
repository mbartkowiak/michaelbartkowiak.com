...
function selecta_post_meta() {
	...
	if ( $tag_list ) {
		$posted_in = __( 'Posted on <a href="%1$s" title="%2$s" rel="bookmark">%2$s</a> in %3$s and tagged %4$s.', 'selecta' );
	} elseif ( is_object_in_taxonomy( get_post_type(), 'category' ) ) {
		$posted_in = __( 'Posted on <a href="%1$s" title="%2$s" rel="bookmark">%2$s</a> in %3$s.', 'selecta' );
	}
